...
public class ReportCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tempDec = spSettings.getString("prefDecimalPlaces", String.valueOf(DEFAULT_DECIMAL_PLACES));
        if(tempDec.equals(""))
            tempDec = String.valueOf(DEFAULT_DECIMAL_PLACES);
        ...
        String tempPass = spSettings.getString("prefPassPercent", String.valueOf(DEFAULT_PASS_PERCENTAGE));
        if(tempPass.equals(""))
            tempPass = String.valueOf(DEFAULT_PASS_PERCENTAGE);
        ...
        checkShowGrade = Integer.parseInt(spSettings.getString("gradePref", String.valueOf(DEFAULT_SHOW_RANK_CHOICE)));
        ...
        for(int i=0; i < subSize+4; i++) {
            ...
            if(i == 0) {
                ...
                cell = new TextView(new ContextThemeWrapper(this, R.style.Cell_Style));
                cell.setText(R.string.report_heading_subject_total);
                row[i].addView(cell);
                cell = new TextView(new ContextThemeWrapper(this, R.style.Cell_Style));
                cell.setText(R.string.report_heading_subject_percentage);
                row[i].addView(cell);
                ...
                for(int k=0; k < testSize+1; k++){
                    if(k==0) {
                        cell = new TextView(new ContextThemeWrapper(this, R.style.Cell_Style));
                        cell.setText(R.string.report_heading_max_marks);
                        row[i].addView(cell);
                    }
                    else {
                        if(checkShowGrade == 1) {
                            ...
                            cell2.setText(R.string.report_heading_grade);
                            row[i].addView(cell2);
                        }
                    }
                }
                ...
                for(int k=0; k < testSize+1; k++){
                    if(k==0){
                        cell = new TextView(new ContextThemeWrapper(this, R.style.Cell_Style));
                        cell.setText(R.string.report_heading_test_total);
                        row[i].addView(cell);
                    }
                    else{
                        if(checkShowGrade == 1){
                ...
                for(int k=0; k < testSize+1; k++){
                    cell = new TextView(new ContextThemeWrapper(this, R.style.Cell_Style));
                    if(k==0)
                        cell.setText(R.string.report_heading_test_percentage);
                    else
                        cell.setText(String.format(getString(R.string.percentage_text), String.valueOf(percentTest[k - 1])));
                    row[i].addView(cell);
                }
                cell = new TextView(new ContextThemeWrapper(this, R.style.Double_Cell_Style));
                cell.setText(String.format(getString(R.string.percentage_text), String.valueOf(overallPercent)));
                row[i].addView(cell);
                dpRelativeLayout.addView(row[i]);
            }
            else{
                ...
                cell = new TextView(new ContextThemeWrapper(this, R.style.Cell_Style));
                cell.setText(String.format(getString(R.string.percentage_text), String.valueOf(percentSub[i - 2])));
                row[i].addView(cell);
                dpRelativeLayout.addView(row[i]);
            }
        }
        ...
        for(int m=0; m < mSize; m++){
            ...
            if(m == 0) {
                ...
                cell.setText(String.format(getString(R.string.report_result_total_marks),
                        String.valueOf(overallTotalObt), String.valueOf(overallMaxMarks)));
                ...
                cell = new TextView(new ContextThemeWrapper(this, R.style.Last_Note_Style));
                cell.setGravity(Gravity.CENTER);
                cell.setText(String.format(getString(R.string.report_result_total_percentage),
                        String.valueOf(overallPercent)));
                ...
                cell = new TextView(new ContextThemeWrapper(this, R.style.Last_Note_Style));
                cell.setGravity(Gravity.CENTER);
                cell.setText(String.format(getString(R.string.report_result), dpResult));
                ...
                cell.setGravity(Gravity.CENTER);
                calculateRank();
                cell.setText(String.format(getString(R.string.report_result_rank), dpRank));
    ...
    void calculateResult(){
        ...
        if(overallPercent.compareTo(dpPass) >= 0){
            ...
            dpResult = getString(R.string.result_fail_text);
    }
    ...
    void calculateRank(){
        ...
        if(overallPercent.compareTo(BigDecimal.valueOf(70)) >= 0)
            ...
            dpRank = getString(R.string.rank_first_class_text);
        else if(overallPercent.compareTo(dpPass) >= 0)
            dpRank = getString(R.string.rank_second_class_text);
        else
            dpRank = getString(R.string.rank_fail_text);
    }
    ...
    String calculateGrade(int marks, int total, int option){
        ...
        if(option == 2){
            ...
            if(inputPercent.compareTo(dpPass) >= 0)
                resChar = getString(R.string.result_pass_character);
            else
                resChar = getString(R.string.result_fail_character);
