...
public class GradePref extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gradeListAdapter = new CustomGradeRangeRowAdapter(GradePref.this, dpItems);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LayoutInflater factory = LayoutInflater.from(GradePref.this);
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(GradePref.this);

                alert.setTitle("New Grade Range");
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if (hasAlphaNum(inputM.getText().toString()) && hasAlphaNum(inputG.getText().toString())){
                                    ...
                                    if (((inputM.getText().toString()).equals("")) || ((inputG.getText().toString()).equals("")))
                                        Toast.makeText(getApplicationContext(), "Either one or both fields empty. Please enter valid value.", Toast.LENGTH_SHORT).show();

                                        //check if score equals pass %
                                    else if ((Integer.parseInt(inputM.getText().toString())) == dpPass)
                                        Toast.makeText(getApplicationContext(), "Range already exists. Try with valid value.", Toast.LENGTH_SHORT).show();
                                        ...
                                        if (flag == 1)
                                            ...
                                            Toast.makeText(getApplicationContext(), "Grade already exists. Try with less % value.", Toast.LENGTH_SHORT).show();
                                        else if (flag == 3)
                                            Toast.makeText(getApplicationContext(), "Entered % less than pass %. Try with valid % value.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                                else{
                                    Toast.makeText(getApplicationContext(), "Please enter proper data.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
        ...
        gradeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(GradePref.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (position == dpItems.size() - 1 || position == dpItems.size() - 2)
                                    Toast.makeText(GradePref.this, "This range cannot be removed!", Toast.LENGTH_SHORT).show();
                                else {
                                    //remove item
                                    ...
                                    gradeList.invalidateViews();
                                    dialog.cancel();
                                    Toast.makeText(GradePref.this, "Range removed!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
